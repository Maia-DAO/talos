...
import {IUniswapV3Factory, UniswapV3Pool} from "@uniswap/v3-core/contracts/UniswapV3Factory.sol";
...
abstract contract TalosTestor is Test {
    ...
    function setUp() public {
        vm.selectFork(vm.createFork(vm.envString("UNISWAP_FORK_RPC_URL"), 211160668));
        ...
        uniswapV3Factory = IUniswapV3Factory(vm.envAddress("UNISWAP_V3_FACTORY_ADDRESS"));
        swapRouter = ISwapRouter(vm.envAddress("UNISWAP_V3_SWAP_ROUTER_ADDRESS"));
        nonfungiblePositionManager =
            INonfungiblePositionManager(payable(vm.envAddress("UNISWAP_V3_NFT_POSITION_MANAGER_ADDRESS")));
        ...
        returns (uint256 shares, uint256 amount0, uint256 amount1)
    {
        ...
        (shares, amount0, amount1) =
            strategy.deposit(amount0Desired, amount1Desired, to, predictedAmount0, predictedAmount1, block.timestamp);
